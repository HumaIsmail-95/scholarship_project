...
class FrontendController extends Controller
{
    public function index()
    {
        ...
        }])->withCount('courses')->take(8)->get();
        $nonFeaturedUnis = University::where('featured', 0)->with(['images' => function ($query) {
            $query->where('type', 'logo')->select('id', 'image_url', 'uni_id');
        }])->withCount('courses')->take(8)->get();
        ...
        return view('website.pages.home', compact('disciplines', 'degrees', 'cities', 'packages', 'popular', 'logo', 'banners', 'featuredUnis', 'nonFeaturedUnis', 'footer', 'footerData'));
    }
    public function allCourses()
    {
        ...
        $footer = Banner::where('page_name', 'footer')->select('image_url')->first();
        $footerData = Setting::select('introduction', 'copy_right', 'facebook_link', 'twitter_link', 'linkedin_link', 'address', 'mobile_1', 'mobile_2')->first();
        return view('website.pages.all_courses', compact('disciplines', 'degrees', 'cities', 'banner', 'logo', 'footer', 'footerData'));
    }
    public function allDegrees()
    {
        $degrees = Degree::withCount('courses')->where('status', 1)->get();
        ...
        $footer = Banner::where('page_name', 'footer')->select('image_url')->first();
        $footerData = Setting::select('introduction', 'copy_right', 'facebook_link', 'twitter_link', 'linkedin_link', 'address', 'mobile_1', 'mobile_2')->first();
        return view('website.pages.all_degrees', compact('disciplines',  'degrees', 'cities', 'banner', 'logo', 'footer', 'footerData'));
    }
    public function subscriptions()
    {
        ...
        $footer = Banner::where('page_name', 'footer')->select('image_url')->first();
        $footerData = Setting::select('introduction', 'copy_right', 'facebook_link', 'twitter_link', 'linkedin_link', 'address', 'mobile_1', 'mobile_2')->first();
        return view('website.pages.subscriptions', compact('disciplines', 'degrees', 'cities', 'packages', 'logo', 'banner', 'footer', 'footerData'));
    }
    public function programs(Request $request)
    {
        ...
        $footer = Banner::where('page_name', 'footer')->select('image_url')->first();
        $footerData = Setting::select('introduction', 'copy_right', 'facebook_link', 'twitter_link', 'linkedin_link', 'address', 'mobile_1', 'mobile_2')->first();
        return view('website.pages.programs', compact('programs', 'disciplines', 'degrees', 'cities', 'logo', 'banner', 'footer', 'footerData', 'degrees'));
    }
    public function programDetails($id)
    {
        ...
        $footer = Banner::where('page_name', 'footer')->select('image_url')->first();
        $footerData = Setting::select('introduction', 'copy_right', 'facebook_link', 'twitter_link', 'linkedin_link', 'address', 'mobile_1', 'mobile_2')->first();
        return view('website.pages.programDetail', compact('programDetail', 'disciplines', 'cities', 'logo', 'banner', 'footer', 'footerData', 'degrees'));
    }
    public function universityDetail($id)
    {
        ...
        $footer = Banner::where('page_name', 'footer')->select('image_url')->first();
        $footerData = Setting::select('introduction', 'copy_right', 'facebook_link', 'twitter_link', 'linkedin_link', 'address', 'mobile_1', 'mobile_2')->first();
        return view('website.pages.universityDetail', compact('universityDetail', 'disciplines', 'degrees', 'cities', 'logo', 'banner', 'footer', 'footerData'));
    }
    public function about()
    {
        ...
        $footerData = Setting::select('introduction', 'copy_right', 'facebook_link', 'twitter_link', 'linkedin_link', 'address', 'mobile_1', 'mobile_2')->first();
        $degrees = Degree::where('status', 1)->get();
        return view('website.pages.about_us', compact('logo', 'banner', 'disciplines', 'degrees', 'cities', 'footer', 'about', 'footerData'));
    }
    public function privacy()
    {
        ...
        $footer = Banner::where('page_name', 'footer')->select('image_url')->first();
        $footerData = Setting::select('introduction', 'copy_right', 'facebook_link', 'twitter_link', 'linkedin_link', 'address', 'mobile_1', 'mobile_2')->first();
        return view('website.pages.privacy', compact('logo', 'banner', 'degrees', 'disciplines', 'cities', 'footer', 'privacy', 'footerData'));
    }
    public function blogs()
    {
        ...
        return view('website.pages.blog', compact('logo', 'banner', 'disciplines', 'degrees', 'cities', 'footer', 'footerData', 'recentBlogs', 'blogs'));
    }
    public function blogDetail(Blog $blog)
    {
        ...
        return view('website.pages.blog_detail', compact('logo', 'banner', 'disciplines', 'degrees', 'cities', 'footer', 'footerData', 'recentBlogs', 'blog'));
    }
}
